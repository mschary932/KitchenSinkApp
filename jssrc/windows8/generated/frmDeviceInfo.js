function addWidgetsfrmDeviceInfo() {
    var hbxDeviceInfo = new kony.ui.Box({
        "id": "hbxDeviceInfo",
        "isVisible": true,
    ...
    vbox192926642422365.add(segDeviceInfo);
    hbxDeviceInfo.add(vbox192926642422365);
    frmDeviceInfo.add(hbxDeviceInfo);
};
...
function frmDeviceInfoGlobals() {
    frmDeviceInfo = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["hbxDeviceInfo", "segDeviceInfo", "vbox192926642422365"],
        "inTransitionConfig": {
            "formTransition": "None"
        },
        "maxAppMenuButtons": 4,
