function addWidgetsfrmSlider() {
    ...
    var slider103994549624243 = new kony.ui.Slider({
        ...
        "isVisible": true,
        "leftSkin": "sliderLeftWin",
        "max": 100,
        "min": 0,
        "rightSkin": "sliderRightWin",
        "step": 1
    }, {
        "containerWeight": 100,
        "hExpand": true,
...
function frmSliderGlobals() {
    frmSlider = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["hbox1181029310129489", "hbxSliders", "label118082077327189", "label118082077327213", "label1181029310129359", "label1181029310129387", "label1181029310129456", "label1181029310129490", "lblSlid", "slider103994549624243", "slider1181029310129369", "slider1181029310129396", "slider192735980026038", "slider192914726036080", "vbox192926642422365"],
        "inTransitionConfig": {
            "formTransition": "None"
        },
        "maxAppMenuButtons": 4,
