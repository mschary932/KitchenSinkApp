function addWidgetsfrmAsyncDataAccess() {
    ...
    var vbox193024952756611 = new kony.ui.Box({
        "id": "vbox193024952756611",
        "isVisible": true,
    ...
    vbox193024952756611.add(lblAppKeyInfo, lblTextBoxHeader, txtAPIKey, button1927359800106315, lnkNoAPIKey);
    hbxAPIKey.add(vbox193024952756611);
    var hbxAsyncDataAccess = new kony.ui.Box({
        "id": "hbxAsyncDataAccess",
        "isVisible": true,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL,
        "position": constants.BOX_POSITION_AS_NORMAL
    }, {
    ...
    vbox192926642422365.add(label192834290335707, tbxFName, tbxLName, button117813958332763, lblErrMsgAsyncData, lblNwConn);
    hbxAsyncDataAccess.add(vbox192926642422365);
    var hbxAsyncDataDisplay = new kony.ui.Box({
        "id": "hbxAsyncDataDisplay",
        "isVisible": true,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL,
        "position": constants.BOX_POSITION_AS_NORMAL
    }, {
    ...
    var vbox193024952756916 = new kony.ui.Box({
        "id": "vbox193024952756916",
        "isVisible": true,
        "orientation": constants.BOX_LAYOUT_VERTICAL,
        "position": constants.BOX_POSITION_AS_NORMAL
    }, {
    ...
    vbox193024952756916.add(segSmall);
    hbxAsyncDataDisplay.add(vbox193024952756916);
    frmAsyncDataAccess.add(hbxAPIKey, hbxAsyncDataAccess, hbxAsyncDataDisplay);
};
...
function frmAsyncDataAccessGlobals() {
    frmAsyncDataAccess = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["button117813958332763", "button1927359800106315", "hbxAPIKey", "hbxAsyncDataAccess", "hbxAsyncDataDisplay", "label192834290335707", "lblAppKeyInfo", "lblErrMsgAsyncData", "lblNwConn", "lblTextBoxHeader", "lnkNoAPIKey", "segSmall", "tbxFName", "tbxLName", "txtAPIKey", "vbox192926642422365", "vbox193024952756611", "vbox193024952756916"],
        "inTransitionConfig": {
            "formTransition": "None"
        },
        "maxAppMenuButtons": 4,
