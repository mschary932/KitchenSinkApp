...
function frmSegmentTabletGlobals() {
    frmSegmentTablet = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["btnEditOrDone", "btnMulSelect", "button118085056487922", "button118290614368754", "button118290614368755", "hbxSegmentOptions", "lblSegWidoutGrpCel", "lblSegWithGrpCels", "segCoverFlowView", "segCylinderView", "segGroupCells", "segGroupCellsWinTab", "segIconEditStyle", "segInvertedCylinderView", "segInvertedRotaryView", "segLinearView", "segMultiRowTemp", "segMultiSelectData", "segPageView", "segPreferredWidth", "segRotatoryView", "segRowAlternateSkin", "segSecHdrTemplates", "segStackView", "segTableView", "segWdtGroupCellsWinTab", "segWidoutGrpCells", "segWithSections", "vbox192926642422365"],
        "inTransitionConfig": {
            "formTransition": "None"
        },
        "maxAppMenuButtons": 4,
