function addWidgetsfrmWebSQLResults() {
    ...
    frmWebSQLResults.add(hbox103994549623663, segWebSQLResults);
};
...
function frmWebSQLResultsGlobals() {
    frmWebSQLResults = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["hbox103994549623663", "label103994549623664", "segWebSQLResults"],
        "inTransitionConfig": {
            "transitionSpeed": 0
        },
        "maxAppMenuButtons": 4,
    ...
    frmWebSQLResults.info = {
        "kuid": "frmWebSQLResultsWinPhone8"
    };
};