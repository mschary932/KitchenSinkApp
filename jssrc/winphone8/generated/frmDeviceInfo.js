function addWidgetsfrmDeviceInfo() {
    ...
    frmDeviceInfo.add(hbox103994549623663, segDeviceInfo);
};
...
function frmDeviceInfoGlobals() {
    frmDeviceInfo = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["hbox103994549623663", "label103994549623664", "segDeviceInfo"],
        "inTransitionConfig": {
            "transitionSpeed": 0
        },
        "maxAppMenuButtons": 4,
