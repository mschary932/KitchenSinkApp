function addWidgetsfrmTabPane() {
    ...
    vbox193203698711084.add(tabpane193203698711085);
    hbxDefaultTbpTab.add(label193203698711290, vbox193203698711084);
    ...
    vbox193203698712658.add(tabpane193203698712660);
    hbxCollapseTbpTab.add(label193203698712674, vbox193203698712658);
    ...
    vbox193203698713778.add(tabpane193203698713780);
    hbxToggleTbpTab.add(label193203698713794, vbox193203698713778);
    ...
    vbox193203698714078.add(tabpane193203698714080);
    hbxImgPosTbpTab.add(label193203698714094, vbox193203698714078);
    ...
    frmTabPane.add(hbxDefaultTbpTab, hbxCollapseTbpTab, hbxToggleTbpTab, hbxImgPosTbpTab, hbxScreenLevelTbpTab);
};
