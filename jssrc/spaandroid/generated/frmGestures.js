function addWidgetsfrmGestures() {
    ...
    var lblFrmGestures = new kony.ui.Label({
        ...
        "text": "Perform Double Tap,Swipe and Longpress  gestures in this form"
    }, {
        "containerWeight": 100,
    ...
    frmGestures.add(hbox103994549623663, lblFrmGestures, imgGes, lblGesture);
};
...
function frmGesturesGlobals() {
    frmGestures = new kony.ui.Form2({
        ...
        "id": "frmGestures",
        "needAppMenu": true,
        "preShow": p2kwiet12889314951249_frmGestures_preshow_seq0,
        "skin": "frm",
        "title": "Gestures"
    }, {
