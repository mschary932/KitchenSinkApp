function addWidgetsfrmForm() {
    ...
    frmForm.add(lblName, tbxName, lblPasword, tbxPassword, lblCountry, cmbCountry, lblBDate, calBDate, lblGender, rbtGender, lblTermsNConditions, rTxTermsNConditions, chkAccept);
};
