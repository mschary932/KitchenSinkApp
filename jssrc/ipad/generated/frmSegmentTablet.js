function addWidgetsfrmSegmentTablet() {
    ...
    var button118290614368754 = new kony.ui.Button({
        ...
        "isVisible": true,
        "onClick": p2kwiet9745998654608_button118290614368754_onClick_seq0,
        "skin": "btnNormal",
        "text": "Views"
    }, {
        "containerWeight": 100,
    ...
    var button118290614368755 = new kony.ui.Button({
        ...
        "isVisible": true,
        "onClick": p2kwiet9745998654608_button118290614368755_onClick_seq0,
        "skin": "btnNormal",
        "text": "Other features"
    }, {
        "containerWeight": 100,
    ...
    var button118085056487922 = new kony.ui.Button({
        "focusSkin": "btnFocus",
        "id": "button118085056487922",
        "isVisible": true,
        "onClick": p2kwiet9745998654608_button118085056487922_onClick_seq0,
        "skin": "btnNormal",
        "text": "Screen level widget features"
    }, {
        "containerWeight": 100,
        "contentAlignment": constants.CONTENT_ALIGN_CENTER,
        "displayText": true,
    ...
    vbox192926642422365.add(button118290614368754, button118290614368755, button118085056487922);
    ...
    var btnMulSelect = new kony.ui.Button({
        ...
        "id": "btnMulSelect",
        "isVisible": true,
        "onClick": p2kwiet9745998654608_btnMulSelect_onClick_seq0,
        "skin": "btnNormal",
    ...
    var btnEditOrDone = new kony.ui.Button({
        ...
        "id": "btnEditOrDone",
        "isVisible": true,
        "onClick": p2kwiet9745998654608_btnEditOrDone_onClick_seq0,
        "skin": "btnNormal",
        "text": "Edit"
    }, {
        "containerWeight": 100,
    ...
    var segIconEditStyle = new kony.ui.SegmentedUI2({
        ...
        "enableDictionary": false,
        "indicator": constants.SEGUI_NONE,
        "onEditing": p2kwiet9745998654608_segIconEditStyle_iPad_onEditing_seq0,
        "progressIndicatorColor": constants.PROGRESS_INDICATOR_COLOR_WHITE,
        "searchCriteria": constants.SEGUI_SEARCH_CRITERIA_STARTSWITH,
        "showProgressIndicator": true
    });
