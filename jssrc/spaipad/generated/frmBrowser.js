function addWidgetsfrmBrowser() {
    var hbxBrowserTabSPA = new kony.ui.Box({
        "focusSkin": "headBox",
        "id": "hbxBrowserTabSPA",
        "isVisible": true,
    ...
    var lblBrowserTabSPA = new kony.ui.Label({
        "id": "lblBrowserTabSPA",
        "isVisible": true,
        "skin": "headLabel",
        "text": "Browser"
    ...
    hbxBrowserTabSPA.add(lblBrowserTabSPA);
    ...
    frmBrowser.add(hbxBrowserTabSPA, hbxInLineBrowser, hbox1930135169595878);
};
